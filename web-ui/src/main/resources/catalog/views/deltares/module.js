(function() {
  ...
  goog.provide('gn_search_deltares');

  goog.require('cookie_warning');
  goog.require('gn_mdactions_directive');
  goog.require('gn_related_directive');
  goog.require('gn_search');
  goog.require('gn_search_deltares_config');
  goog.require('gn_search_deltares_directive');

  var module = angular.module('gn_search_deltares',
      ['gn_search', 'gn_search_deltares_config',
       'gn_search_deltares_directive', 'gn_related_directive',
