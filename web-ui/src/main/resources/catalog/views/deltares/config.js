(function() {
  ...
  goog.provide('gn_search_deltares_config');

  var module = angular.module('gn_search_deltares_config', []);
      ...
      .run([
        ...
        function(searchSettings, viewerSettings, gnOwsContextService, gnMap) {
          ...
          searchSettings.resultViewTpls = [{
                  tplUrl: '../../catalog/views/deltares/templates/result_view/grid.html',
                  tooltip: 'Grid',
                  icon: 'fa-th'
                }];
